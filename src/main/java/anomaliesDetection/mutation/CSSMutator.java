package anomaliesDetection.mutation;
                        ...
                        if (rb.equals(block)) {
                            ...
                            if (rb.asList().equals(block.asList())) {
                                ...
                                for (RuleBlock toMatch : b2) {
                                    ...
                                    List<CombinedSelector> sels = Arrays.asList(((RuleSet) toMatch).getSelectors());
                                    for (RuleBlock origRb : b1) {
                                        List<CombinedSelector> selsOrig = Arrays.asList(((RuleSet) origRb).getSelectors());
